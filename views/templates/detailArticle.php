...
<div class="comments">
    ...
    if (empty($comments)) {
        ...
        foreach ($comments as $comment) {
            ...
            // Si l'utilisateur est connecté, on affiche un bouton pour supprimer le commentaire.
            if (isset($_SESSION['user'])) {
                echo '<div class="deleteComment">';
                echo '  <a class="submit" href="index.php?action=deleteComment&id=' . $comment->getId() . '" ' . Utils::askConfirmation("Êtes-vous sûr de vouloir supprimer ce commentaire ?") . '>Supprimer</a>';
                echo '</div>';
            }
        }
        echo '</ul>';
